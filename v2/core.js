...
function installDailyQuest(){
 ...
 let urgency=d.days===null?"시험일을 설정하면 남은 기간에 맞춰 학습 우선순위를 조정합니다.":d.days===0?"시험일입니다. 새 내용보다 오답·말하기 복습을 우선하세요.":d.days<=7?"시험까지 "+d.days+"일 · 오답과 실전 문제 비중을 높입니다.":"시험까지 "+d.days+"일 · 약점과 새 학습을 균형 있게 진행합니다.";
